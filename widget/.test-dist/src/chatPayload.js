...
export const WELCOME_MESSAGE = 'Bonjour, posez-moi une question sur le site. Je peux aussi vous orienter vers un premier echange ou un audit selon votre besoin.';
